...
import com.kitcenter.app.homework.lesson5.*;
        ...
        while (true) {
            ...
            try {
                ...
                switch (menuNumber) {
                    ...
                    case 5: {
                        double pi = 3.14, r = 3.123;
                        System.out.println("Circuit value = " + MathCircuit.circuit(pi, r));
                        break;
                    }
                    case 6: {
                        int a = 15, b = 3;
                    ...
                    case 15: {
                        double pi = 3.14, r = 3.123;
                        System.out.println("Sphere Area value = " + MathSphereArea.sphereArea(pi, r));
                        break;
                    }
                    case 16: {
                        double pi = 3.14, r = 3.123;
                        System.out.println("Sphere Volume value = " + MathSphereVolume.sphereVolume(pi, r));
                        break;
                    }
                    case 17: {
                        int a = 9;
